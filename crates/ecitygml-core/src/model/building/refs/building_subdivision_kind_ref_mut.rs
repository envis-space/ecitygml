...
use crate::model::building::{
    ...
    BuildingSubdivisionKind, BuildingUnit, Storey,
};
use crate::model::common::FeatureType;
use crate::model::common::HasFeatureType;

#[derive(Debug)]
pub enum BuildingSubdivisionKindRefMut<'a> {
    BuildingUnit(&'a mut BuildingUnit),
    Storey(&'a mut Storey),
}

impl<'a> From<&'a mut BuildingSubdivisionKind> for BuildingSubdivisionKindRefMut<'a> {
...
impl<'a> AsAbstractBuildingSubdivision for BuildingSubdivisionKindRefMut<'a> {
...
impl<'a> AsAbstractBuildingSubdivisionMut for BuildingSubdivisionKindRefMut<'a> {
...
crate::impl_abstract_building_subdivision_traits!(BuildingSubdivisionKindRefMut<'_>);
crate::impl_abstract_building_subdivision_mut_traits!(BuildingSubdivisionKindRefMut<'_>);

impl<'a> BuildingSubdivisionKindRefMut<'a> {
...
impl<'a> HasFeatureType for BuildingSubdivisionKindRefMut<'a> {
...
macro_rules! impl_from_building_subdivision_kind_ref_mut {
    ($type:ident) => {
        impl<'a> From<&'a mut $type>
            for $crate::model::building::refs::BuildingSubdivisionKindRefMut<'a>
        {
            fn from(x: &'a mut $type) -> Self {
                $crate::model::building::refs::BuildingSubdivisionKindRefMut::$type(x.into())
            }
        }
        $crate::impl_from_for_logical_space_kind_ref_mut!(BuildingSubdivisionKind, $type);
    };
}
...
macro_rules! impl_try_from_building_subdivision_kind_ref_mut {
    ($type:ident) => {
        impl<'a> TryFrom<$crate::model::building::refs::BuildingSubdivisionKindRefMut<'a>>
            for &'a mut $type
        {
            type Error = ();
            fn try_from(
                x: $crate::model::building::refs::BuildingSubdivisionKindRefMut<'a>,
            ) -> Result<Self, ()> {
                match x {
                    $crate::model::building::refs::BuildingSubdivisionKindRefMut::$type(k) => {
        ...
        $crate::impl_try_from_for_logical_space_kind_ref_mut!(BuildingSubdivisionKind, $type);
    };
}
...
impl_try_from_logical_space_kind_ref_mut_for_enum!(
    BuildingSubdivisionKind,
    BuildingSubdivisionKindRefMut
);
