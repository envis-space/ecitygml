...
crate::impl_abstract_construction_surface_mut_traits!(OuterCeilingSurface);
crate::impl_has_feature_type!(OuterCeilingSurface, OuterCeilingSurface);

impl IterFeatures for OuterCeilingSurface {
...
impl ForEachFeatureMut for OuterCeilingSurface {
...
impl ComputeEnvelope for OuterCeilingSurface {
    fn compute_envelope(&self) -> Option<Envelope> {
        self.abstract_construction_surface.compute_envelope()
    }
}

impl ApplyTransform for OuterCeilingSurface {
