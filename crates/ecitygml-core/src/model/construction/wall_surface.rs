...
crate::impl_abstract_construction_surface_mut_traits!(WallSurface);
crate::impl_has_feature_type!(WallSurface, WallSurface);

impl IterFeatures for WallSurface {
...
impl ForEachFeatureMut for WallSurface {
...
impl ComputeEnvelope for WallSurface {
    fn compute_envelope(&self) -> Option<Envelope> {
        self.abstract_construction_surface.compute_envelope()
    }
}

impl ApplyTransform for WallSurface {
