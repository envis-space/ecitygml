...
impl<'a> From<&'a RoofSurface> for FeatureRef<'a> {
    fn from(item: &'a RoofSurface) -> Self {
        FeatureRef::RoofSurface(item)
    }
}

impl<'a> From<&'a mut RoofSurface> for FeatureRefMut<'a> {
    fn from(item: &'a mut RoofSurface) -> Self {
        FeatureRefMut::RoofSurface(item)
    }
}
