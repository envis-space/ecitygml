...
crate::impl_abstract_construction_surface_mut_traits!(InteriorWallSurface);
crate::impl_has_feature_type!(InteriorWallSurface, InteriorWallSurface);

impl IterFeatures for InteriorWallSurface {
...
impl ForEachFeatureMut for InteriorWallSurface {
...
impl ComputeEnvelope for InteriorWallSurface {
    fn compute_envelope(&self) -> Option<Envelope> {
        self.abstract_construction_surface.compute_envelope()
    }
}

impl ApplyTransform for InteriorWallSurface {
