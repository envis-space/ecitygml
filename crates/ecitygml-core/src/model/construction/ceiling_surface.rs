...
crate::impl_abstract_construction_surface_mut_traits!(CeilingSurface);
crate::impl_has_feature_type!(CeilingSurface, CeilingSurface);

impl IterFeatures for CeilingSurface {
...
impl ForEachFeatureMut for CeilingSurface {
...
impl ComputeEnvelope for CeilingSurface {
    fn compute_envelope(&self) -> Option<Envelope> {
        self.abstract_construction_surface.compute_envelope()
    }
}

impl ApplyTransform for CeilingSurface {
