...
impl AsAbstractConstructionSurface for FloorSurface {
    fn abstract_construction_surface(&self) -> &AbstractConstructionSurface {
        &self.abstract_construction_surface
    }
}

impl AsAbstractConstructionSurfaceMut for FloorSurface {
    fn abstract_construction_surface_mut(&mut self) -> &mut AbstractConstructionSurface {
        &mut self.abstract_construction_surface
    }
}

crate::impl_abstract_construction_surface_traits!(FloorSurface);
crate::impl_abstract_construction_surface_mut_traits!(FloorSurface);
crate::impl_has_feature_type!(FloorSurface, FloorSurface);

impl IterFeatures for FloorSurface {
...
impl ForEachFeatureMut for FloorSurface {
...
impl ComputeEnvelope for FloorSurface {
    fn compute_envelope(&self) -> Option<Envelope> {
        self.abstract_construction_surface.compute_envelope()
    }
}

impl ApplyTransform for FloorSurface {
