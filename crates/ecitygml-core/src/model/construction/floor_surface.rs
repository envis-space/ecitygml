...
impl<'a> From<&'a FloorSurface> for FeatureRef<'a> {
    fn from(item: &'a FloorSurface) -> Self {
        FeatureRef::FloorSurface(item)
    }
}

impl<'a> From<&'a mut FloorSurface> for FeatureRefMut<'a> {
    fn from(item: &'a mut FloorSurface) -> Self {
        FeatureRefMut::FloorSurface(item)
    }
}
