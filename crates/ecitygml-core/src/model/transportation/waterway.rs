...
pub struct Waterway {
    ...
    class: Option<WaterwayClassValue>,
    functions: Vec<WaterwayFunctionValue>,
    usages: Vec<WaterwayUsageValue>,
...
impl Waterway {
    ...
    pub fn class(&self) -> Option<&WaterwayClassValue> {
        self.class.as_ref()
    }

    pub fn set_class(&mut self, class: WaterwayClassValue) {
        self.class = Some(class);
    }

    pub fn set_class_opt(&mut self, class: Option<WaterwayClassValue>) {
        self.class = class;
    }
    ...
    pub fn functions(&self) -> &[WaterwayFunctionValue] {
        &self.functions
    }

    pub fn functions_mut(&mut self) -> &mut [WaterwayFunctionValue] {
        &mut self.functions
    }

    pub fn set_functions(&mut self, functions: Vec<WaterwayFunctionValue>) {
        self.functions = functions;
    }

    pub fn push_function(&mut self, function: WaterwayFunctionValue) {
        self.functions.push(function);
    }

    pub fn extend_functions(&mut self, functions: impl IntoIterator<Item = WaterwayFunctionValue>) {
        self.functions.extend(functions);
    }

    pub fn usages(&self) -> &[WaterwayUsageValue] {
        &self.usages
    }

    pub fn usages_mut(&mut self) -> &mut [WaterwayUsageValue] {
        &mut self.usages
    }

    pub fn set_usages(&mut self, usages: Vec<WaterwayUsageValue>) {
        self.usages = usages;
    }

    pub fn push_usage(&mut self, usage: WaterwayUsageValue) {
        self.usages.push(usage);
    }

    pub fn extend_usages(&mut self, usages: impl IntoIterator<Item = WaterwayUsageValue>) {
...
impl AsAbstractTransportationSpace for Waterway {
    fn abstract_transportation_space(&self) -> &AbstractTransportationSpace {
        &self.abstract_transportation_space
    }
}

impl AsAbstractTransportationSpaceMut for Waterway {
    fn abstract_transportation_space_mut(&mut self) -> &mut AbstractTransportationSpace {
        &mut self.abstract_transportation_space
    }
}

crate::impl_abstract_transportation_space_traits!(Waterway);
crate::impl_abstract_transportation_space_mut_traits!(Waterway);
crate::impl_has_feature_type!(Waterway, Waterway);

impl IterFeatures for Waterway {
...
impl ForEachFeatureMut for Waterway {
...
impl ComputeEnvelope for Waterway {
    fn compute_envelope(&self) -> Option<Envelope> {
        self.abstract_transportation_space.compute_envelope()
    }
}

impl ApplyTransform for Waterway {
